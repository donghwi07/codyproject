                     ...
                     <div class="card-body"
                        ...
                        <c:forEach var="item" items="${irr.itemtime}" begin="0" end="2"
                           ...
                           <div style="padding-bottom: 10px;">
                              ...
                              &emsp;${item.item_price}원<button class="btn btn-info"
                                 style="position: absolute; right: 10px;"onclick="window.open('${item.item_link }', 'buyItem', 'width=1000px, height=700px')">구입</button>
                           </div>
